...
class PaintGUI:
    def __init__(self) -> None:
        ...
        self.image = Pil_Img.new("RGB", (WIDTH, HEIGHT), WHITE)
        ...
        self.root.protocol("WM_DELETE_WINDPW", self.on_closing)
    ...
    def paint(self, event):
        ...
        self.draw.rectangle([x1, y1,x2 + self.brush_width, y2 + self.brush_width], outline = self.current_color, fill = self.current_color)
    ...
    def clear(self):
        self.cnv.delete("all")
        self.rectangle([0,0,1000,1000], fill= "white")
