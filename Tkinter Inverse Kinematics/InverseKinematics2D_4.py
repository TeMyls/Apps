...
class Kinematics(ttk.Frame):
    def __init__(self, parent, c_width, c_height):
        ...
        arrange_widgets(btn_arrangement, "S")
    ...
    def on_canvas_resize(self, event):
        ...
        #self.rotation_scl.config(width=int(self.btn_frame.cget("width")) + self.canvas_width + int(self.data_frame.cget("width")))
    ...
    def FABRIK(self):
        if len(self.vertices) > 1 and self.target_idx != -1 and self.target_idx != self.selected_idx:
            ...
            #childern = self.dfs(self.edges, self.selected_idx)
